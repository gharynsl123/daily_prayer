import 'package:daily_prayer/view/datail_doa.dart';
import 'package:daily_prayer/view/text_style.dart';
...
//  isi dari detailnya
  List<String> doaArab = [
    ...
    "دُ ِللهِ الَّذِىْ اَطْعَمَنَا وَسَقَانَا وَجَعَلَنَا مُسْلِمِيْن",
    "بِسْمِ اللهِ فِىِ أَوَّلِهِ وَآخِرِهِ",
    "بِسْمِكَ اللّٰهُمَّ اَحْيَا وَاَمُوْت",
    "اَلْحَمْدُ ِللهِ الَّذِىْ اَحْيَانَا بَعْدَمَآ اَمَاتَنَا وَاِلَيْهِ النُّشُوْر",
    "اَللّٰهُمَّ إِنّىِ أَعُوْذُ بِكَ مِنْ عَمَلِ الشَّيْطَانِ وَسَيِّئاَتِ اْلأَحْلاَم",
    ...
    "اَلْحَمْدُ لِلّٰهِ الَّذِىْ كَسَانِىْ هَذَا وَرَزَقَنِيْهِ مِنْ غَيْرِ حَوْلٍ مِنِّىْ وَلاَقُوَّة",
    "بِسْمِ اللهِ الَّذِيْ لاَ إِلَهَ إِلَّا هُوَ",
    "اَللّٰهُمَّ اِنِّى اَسْأَلُكَ عِلْمًا نَافِعًا وَرِزْقًا طَيِّبًا وَعَمَلاً مُتَقَبَّلا",
    "يَارَبِّ زِدْنِىْ عِلْمًا وَارْزُقْنِىْ فَهْمًا",
    "اَللّٰهُمَّ اِنِّى اِسْتَوْدِعُكَ مَاعَلَّمْتَنِيْهِ فَارْدُدْهُ اِلَىَّ عِنْدَ حَاجَتِىْ وَلاَ تَنْسَنِيْهِ يَارَبَّ الْعَالَمِيْن",
  ...
  List<String> artiDoa = [
    "Artinya: Ya Allah, berkahilah kami dalam rezeki yang telah Engkau berikan kepada kami dan peliharalah kami dari siksa api nerak",
    "Artinya: Segala puji bagi Allah yang telah memberi makan kami dan minuman kami, serta menjadikan kami sebagai orang-orang isla",
    "Artinya: Dengan menyebut nama Allah pada awal dan akhirny",
    "Artinya: Dengan menyebut nama-Mu ya Allah, aku hidup dan aku mati",
    "Artinya: Segala puji bagi Allah yang telah menghidupkan kami sesudah kami mati (membangunkan dari tidur) dan hanya kepada-Nya kami dikembalika",
    "Artinya: Ya Allah, sesungguhnya aku mohon perlindungan kepada Engkau dari perbuatan setan dan dari mimpi-mimpi yang buru",
...
//        nah disini kasih aja istilahnya
          final topTitle = namaDoa[index].toString();
          final isiArab = doaArab[index].toString();
          final isiArti = artiDoa[index].toString();
          final gambar = gambarNumber[index].toString();
...
//                    ini ambil istilah dari yang antum buat tadi
                    child: listItem(topTitle, isiArab, isiArti, gambar),
              ...
              onTap: () {
                Navigator.push(context, MaterialPageRoute(
                    builder: (context) => DeatailDoaPage(itemBar: topTitle,
                        itemArab: isiArab, itemArtti: isiArti, itemNomor: gambar)
                ));
              },
            ),
          );
...
// ini buat setting text antum
  listItem(String topTitle, String isiArab, String isiArti, String gambar) {
       ...
       mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: <Widget>[
          Padding(
              ...
              child: Text(gambar, style: nomor)),
          Text(topTitle, style: topTitleStyle),
        ],
      ),
    );
  }
